...
.PHONY: all build_ftb-dw20 ftb-dw20-17 build_ftb-infinity build_spigot build_tekkit build_vanilla release

all: build_ftb-dw20 ftb-dw20-17 build_ftb-infinity build_spigot build_tekkit build_vanilla
...
build_ftb-infinity:
	docker build -t $(NAME):ftb-infinity ftb-infinity
